...
function getDataShop() {
    products.forEach((product => {
        cartElement.innerHTML += `
            <div class="card">
                <a href="">
                    <img class="img1" src="../../images/home_se3Photo/home_se3Photo1.webp" alt="">
                </a>
                <a href="">
                    <img class="img2" src="../../images/home_se3Photo/home_se3photo2.png" alt="">
                </a>
...
function copyLink() {
    var emailText = document.getElementById("linkGmail").innerText;
    navigator.clipboard.writeText(emailText).then(() => {
        alert("Email kopyalandı: " + emailText);
    });
}
